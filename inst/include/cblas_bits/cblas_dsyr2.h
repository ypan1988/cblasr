...
#ifndef CBLAS_DSYR2_H_
#define CBLAS_DSYR2_H_

void cblas_dsyr2(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const int N,
...
#define F77_lda lda
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(dsyr2)
    (F77_UL, &F77_N, &alpha, X, &F77_incX, Y, &F77_incY, A, &F77_lda);
