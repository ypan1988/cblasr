 ...
 *
 */
#ifndef CBLAS_ZHEMV_H_
#define CBLAS_ZHEMV_H_

#include <stdio.h>
#include <stdlib.h>
void cblas_zhemv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const int N,
...
#endif
    F77_NAME(zhemv)
    (F77_UL, &F77_N, (const Rcomplex *)alpha, (const Rcomplex *)A, &F77_lda,
     (const Rcomplex *)X, &F77_incX, (const Rcomplex *)beta, (Rcomplex *)Y,
     &F77_incY);
