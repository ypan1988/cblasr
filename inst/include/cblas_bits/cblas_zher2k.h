...
#ifndef CBLAS_ZHER2K_H_
#define CBLAS_ZHER2K_H_

inline void cblas_zher2k(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_ldc ldc
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(zher2k)
    (F77_UL, F77_TR, &F77_N, &F77_K, (const Rcomplex *)alpha,
     (const Rcomplex *)A, &F77_lda, (const Rcomplex *)B, &F77_ldb, &beta,
     (Rcomplex *)C, &F77_ldc);
    ...
    cblas_xerbla(1, "cblas_zher2k", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
