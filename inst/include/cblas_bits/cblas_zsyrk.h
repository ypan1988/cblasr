...
#ifndef CBLAS_ZSYRK_H_
#define CBLAS_ZSYRK_H_

inline void cblas_zsyrk(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_ldc ldc
  ...
  if (layout == CblasColMajor) {
    ...
    (F77_UL, F77_TR, &F77_N, &F77_K, (const Rcomplex *)alpha,
     (const Rcomplex *)A, &F77_lda, (const Rcomplex *)beta, (Rcomplex *)C,
     &F77_ldc);
