...
#ifndef CBLAS_ZTRSM_H_
#define CBLAS_ZTRSM_H_

inline void cblas_ztrsm(const CBLAS_LAYOUT layout, const CBLAS_SIDE Side,
...
#define F77_ldb ldb
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(ztrsm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_M, &F77_N, (Rcomplex *)alpha,
     (Rcomplex *)A, &F77_lda, (Rcomplex *)B, &F77_ldb);
    ...
    F77_NAME(ztrsm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_N, &F77_M, (Rcomplex *)alpha,
     (Rcomplex *)A, &F77_lda, (Rcomplex *)B, &F77_ldb);
  } else
    cblas_xerbla(1, "cblas_ztrsm", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
