...
#define F77_ldb ldb
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(ztrmm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_M, &F77_N, (const Rcomplex *)alpha,
     (const Rcomplex *)A, &F77_lda, (Rcomplex *)B, &F77_ldb);
    ...
    F77_NAME(ztrmm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_N, &F77_M, (const Rcomplex *)alpha,
     (const Rcomplex *)A, &F77_lda, (Rcomplex *)B, &F77_ldb);
  } else
