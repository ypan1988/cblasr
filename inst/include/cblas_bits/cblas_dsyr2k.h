...
#ifndef CBLAS_DSYR2K_H_
#define CBLAS_DSYR2K_H_

inline void cblas_dsyr2k(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_ldc ldc
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(dsyr2k)
    (F77_UL, F77_TR, &F77_N, &F77_K, &alpha, A, &F77_lda, B, &F77_ldb, &beta, C,
     &F77_ldc);
