...
#ifndef CBLAS_DTBSV_H_
#define CBLAS_DTBSV_H_

inline void cblas_dtbsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_incX incX
  ...
  if (layout == CblasColMajor) {
...
#endif
    F77_NAME(dtbsv)
    (F77_UL, F77_TA, F77_DI, &F77_N, &F77_K, A, &F77_lda, X, &F77_incX);
    ...
    cblas_xerbla(1, "cblas_dtbsv", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
