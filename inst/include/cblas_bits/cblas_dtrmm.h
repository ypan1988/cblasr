...
#ifndef CBLAS_DTRMM_H_
#define CBLAS_DTRMM_H_
...
#define F77_ldb ldb
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(dtrmm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_M, &F77_N, &alpha, A, &F77_lda, B,
     &F77_ldb);
...
#endif
    F77_NAME(dtrmm)
    (F77_SD, F77_UL, F77_TA, F77_DI, &F77_N, &F77_M, &alpha, A, &F77_lda, B,
     &F77_ldb);
  } else
    cblas_xerbla(1, "cblas_dtrmm", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
