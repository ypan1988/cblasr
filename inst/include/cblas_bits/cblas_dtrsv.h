...
#ifndef CBLAS_DTRSV_H_
#define CBLAS_DTRSV_H_

inline void cblas_dtrsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_incX incX
  ...
  if (layout == CblasColMajor) {
    ...
    F77_DI = C2F_CHAR(&DI);
#endif
    F77_NAME(dtrsv)(F77_UL, F77_TA, F77_DI, &F77_N, A, &F77_lda, X, &F77_incX);
    ...
    cblas_xerbla(1, "cblas_dtrsv", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
