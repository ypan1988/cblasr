...
#define F77_ldc ldc
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(zgemm)
    (F77_TA, F77_TB, &F77_M, &F77_N, &F77_K, (const Rcomplex *)alpha,
    ...
    F77_NAME(zgemm)
    (F77_TA, F77_TB, &F77_N, &F77_M, &F77_K, (const Rcomplex *)alpha,
     (const Rcomplex *)B, &F77_ldb, (const Rcomplex *)A, &F77_lda,
     (const Rcomplex *)beta, (Rcomplex *)C, &F77_ldc);
  } else
