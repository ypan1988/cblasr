...
#ifndef CBLAS_ZTBMV_H_
#define CBLAS_ZTBMV_H_

inline void cblas_ztbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#endif
    F77_NAME(ztbmv)
    (F77_UL, F77_TA, F77_DI, &F77_N, &F77_K, (const Rcomplex *)A, &F77_lda,
     (Rcomplex *)X, &F77_incX);
