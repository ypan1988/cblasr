...
#ifndef CBLAS_ZTPSV_H_
#define CBLAS_ZTPSV_H_

inline void cblas_ztpsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_incX incX
  ...
  if (layout == CblasColMajor) {
...
#endif
    F77_NAME(ztpsv)
    (F77_UL, F77_TA, F77_DI, &F77_N, (const Rcomplex *)Ap, (Rcomplex *)X,
     &F77_incX);
    ...
    cblas_xerbla(1, "cblas_ztpsv", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
