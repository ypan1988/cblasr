...
#ifndef CBLAS_ZTRMV_H_
#define CBLAS_ZTRMV_H_

inline void cblas_ztrmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo,
...
#define F77_incX incX
  ...
  if (layout == CblasColMajor) {
...
#endif
    F77_NAME(ztrmv)
    (F77_UL, F77_TA, F77_DI, &F77_N, (const Rcomplex *)A, &F77_lda,
     (Rcomplex *)X, &F77_incX);
    ...
    cblas_xerbla(1, "cblas_ztrmv", "Illegal layout setting, %d\n", layout);
  CBLAS_CallFromC = 0;
  RowMajorStrg = 0;
  return;
}
