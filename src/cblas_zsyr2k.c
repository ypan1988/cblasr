                  ...
                  void  *C, const int ldc)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      F77_NAME(zsyr2k)(F77_UL, F77_TR, &F77_N, &F77_K, (Rcomplex *)alpha, (Rcomplex *)A, &F77_lda,
   ...
   } else if (layout == CblasRowMajor)
   {
      ...
      F77_NAME(zsyr2k)(F77_UL, F77_TR, &F77_N, &F77_K, (Rcomplex *)alpha, (Rcomplex *)A, &F77_lda, (Rcomplex *)B, &F77_ldb, (Rcomplex *)beta, (Rcomplex *)C, &F77_ldc);
   }
