...
#define F77_incY incY
  ...
  if (layout == CblasColMajor) {
    ...
    if (TransA == CblasConjTrans)
      F77_NAME(zgemv)
      (F77_TA, &F77_N, &F77_M, (const Rcomplex *)ALPHA, A, &F77_lda,
       (const Rcomplex *)x, &F77_incX, (const Rcomplex *)BETA, Y, &F77_incY);
    else
      F77_NAME(zgemv)
      (F77_TA, &F77_N, &F77_M, alpha, A, &F77_lda, (const Rcomplex *)x,
