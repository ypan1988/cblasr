                  ...
                  void *C, const int ldc)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      F77_NAME(zher2k)(F77_UL, F77_TR, &F77_N, &F77_K, alpha, A, &F77_lda, B, &F77_ldb, &beta, C, &F77_ldc);
   } else if (layout == CblasRowMajor)
   {
      ...
      ALPHA[0]= *alp;
      ALPHA[1]= -alp[1];
      F77_NAME(zher2k)(F77_UL,F77_TR, &F77_N, &F77_K, (const Rcomplex *)ALPHA, A, &F77_lda, B, &F77_ldb, &beta, C, &F77_ldc);
