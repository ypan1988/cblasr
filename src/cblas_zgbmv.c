                 ...
                 void  *Y, const int incY)
{
   ...
   if (layout == CblasColMajor)
   {
      ...
      else
      {
         ...
         F77_TA = C2F_CHAR(&TA);
      #endif
      F77_NAME(zgbmv)(F77_TA, &F77_M, &F77_N, &F77_KL, &F77_KU, (Rcomplex *)alpha,
               (Rcomplex *)A, &F77_lda, (Rcomplex *)X, &F77_incX, (Rcomplex *)beta, (Rcomplex *)Y, &F77_incY);
   }
   else if (layout == CblasRowMajor)
   {
      ...
      if (TransA == CblasConjTrans)
         F77_NAME(zgbmv)(F77_TA, &F77_N, &F77_M, &F77_KU, &F77_KL, (Rcomplex *)ALPHA,
                  (Rcomplex *)A ,&F77_lda, (Rcomplex *)x,&F77_incX, (Rcomplex *)BETA, (Rcomplex *)Y, &F77_incY);
      else
         F77_NAME(zgbmv)(F77_TA, &F77_N, &F77_M, &F77_KU, &F77_KL, (Rcomplex *)alpha,
                  (Rcomplex *)A ,&F77_lda, (Rcomplex *)x,&F77_incX, (Rcomplex *)beta, (Rcomplex *)Y, &F77_incY);
