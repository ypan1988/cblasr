...
#include <stdlib.h>
#include "cblas.h"
void cblas_zhpr(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const int N,
...
#define F77_incX incx
  ...
  if (layout == CblasColMajor) {
    ...
    F77_NAME(zhpr)(F77_UL, &F77_N, &alpha, X, &F77_incX, A);
    ...
    F77_NAME(zhpr)(F77_UL, &F77_N, &alpha, (const Rcomplex *)x, &F77_incX, A);
