                 ...
                 void  *B, const int ldb)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      F77_NAME(ztrsm)(F77_SD, F77_UL, F77_TA, F77_DI, &F77_M, &F77_N, (Rcomplex *)alpha, (Rcomplex *)A,
                &F77_lda, B, &F77_ldb);
   } else if (layout == CblasRowMajor)
   {
      ...
      F77_NAME(ztrsm)(F77_SD, F77_UL, F77_TA, F77_DI, &F77_N, &F77_M, (Rcomplex *)alpha, (Rcomplex *)A,
                &F77_lda, B, &F77_ldb);
   }
