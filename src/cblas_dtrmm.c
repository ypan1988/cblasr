                 ...
                 double  *B, const int ldb)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      F77_NAME(dtrmm)(F77_SD, F77_UL, F77_TA, F77_DI, &F77_M, &F77_N, &alpha, A, &F77_lda, B, &F77_ldb);
   } else if (layout == CblasRowMajor)
   {
      ...
      else
      {
         ...
         F77_DI = C2F_CHAR(&DI);
      #endif
      F77_NAME(dtrmm)(F77_SD, F77_UL, F77_TA, F77_DI, &F77_N, &F77_M, &alpha, A, &F77_lda, B, &F77_ldb);
   }
