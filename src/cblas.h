...
void cblas_sgbmv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
...
void cblas_dgbmv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
...
void cblas_cgemv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
                 ...
                 const int incY);
void cblas_cgbmv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
                 const int N, const int KL, const int KU, const void *alpha,
...
void cblas_ctpmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA,
                 CBLAS_DIAG Diag, const int N, const void *Ap, void *X,
                 const int incX);
...
void cblas_zgemv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
                 ...
                 const void *X, const int incX, const void *beta, void *Y,
                 const int incY);
void cblas_zgbmv(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE TransA, const int M,
                 const int N, const int KL, const int KU, const void *alpha,
                 const void *A, const int lda, const void *X, const int incX,
                 const void *beta, void *Y, const int incY);
 ...
 */
void cblas_ssymv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const float alpha, const float *A, const int lda,
                 const float *X, const int incX, const float beta, float *Y,
                 const int incY);
void cblas_ssbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N, const int K,
                 const float alpha, const float *A, const int lda,
                 const float *X, const int incX, const float beta, float *Y,
                 const int incY);
void cblas_sspmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
...
void cblas_ssyr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const float alpha, const float *X, const int incX, float *A,
                const int lda);
void cblas_sspr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const float alpha, const float *X, const int incX, float *Ap);
void cblas_ssyr2(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const float alpha, const float *X, const int incX,
                 const float *Y, const int incY, float *A, const int lda);
void cblas_sspr2(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const float alpha, const float *X, const int incX,
                 const float *Y, const int incY, float *A);

void cblas_dsymv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const double alpha, const double *A, const int lda,
                 const double *X, const int incX, const double beta, double *Y,
                 const int incY);
void cblas_dsbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N, const int K,
                 const double alpha, const double *A, const int lda,
                 const double *X, const int incX, const double beta, double *Y,
                 const int incY);
void cblas_dspmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
...
void cblas_dsyr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const double alpha, const double *X, const int incX, double *A,
                const int lda);
void cblas_dspr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const double alpha, const double *X, const int incX,
                double *Ap);
void cblas_dsyr2(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const double alpha, const double *X, const int incX,
                 const double *Y, const int incY, double *A, const int lda);
void cblas_dspr2(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const double alpha, const double *X, const int incX,
 ...
 */
void cblas_chemv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const void *alpha, const void *A, const int lda, const void *X,
                 const int incX, const void *beta, void *Y, const int incY);
void cblas_chbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N, const int K,
                 const void *alpha, const void *A, const int lda, const void *X,
                 const int incX, const void *beta, void *Y, const int incY);
void cblas_chpmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
...
void cblas_cgerc(CBLAS_LAYOUT layout, const int M, const int N,
                 const void *alpha, const void *X, const int incX,
                 const void *Y, const int incY, void *A, const int lda);
void cblas_cher(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const float alpha, const void *X, const int incX, void *A,
                const int lda);
void cblas_chpr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const float alpha, const void *X, const int incX, void *A);
...
void cblas_zhemv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const void *alpha, const void *A, const int lda, const void *X,
                 const int incX, const void *beta, void *Y, const int incY);
void cblas_zhbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N, const int K,
                 const void *alpha, const void *A, const int lda, const void *X,
                 const int incX, const void *beta, void *Y, const int incY);
void cblas_zhpmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                 const void *alpha, const void *Ap, const void *X,
                 const int incX, const void *beta, void *Y, const int incY);
...
void cblas_zgerc(CBLAS_LAYOUT layout, const int M, const int N,
                 const void *alpha, const void *X, const int incX,
                 const void *Y, const int incY, void *A, const int lda);
void cblas_zher(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const double alpha, const void *X, const int incX, void *A,
                const int lda);
void cblas_zhpr(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo, const int N,
                const double alpha, const void *X, const int incX, void *A);
