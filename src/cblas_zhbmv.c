                 ...
                 void  *Y, const int incY)
{
   ...
   if (layout == CblasColMajor)
   {
      ...
      else
      {
         ...
         F77_UL = C2F_CHAR(&UL);
      #endif
      F77_NAME(zhbmv)(F77_UL, &F77_N, &F77_K, alpha, A, &F77_lda, X,
   ...
   else if (layout == CblasRowMajor)
   {
      ...
      else
      {
         ...
         F77_UL = C2F_CHAR(&UL);
      #endif
      F77_NAME(zhbmv)(F77_UL, &F77_N, &F77_K, (const Rcomplex *)ALPHA,
                     A ,&F77_lda, (const Rcomplex *)x,&F77_incX, (const Rcomplex *)BETA, Y, &F77_incY);
   }
   else
   {
